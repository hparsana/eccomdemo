...
const ProductDetail = () => {
  ...
  return (
    <>
                  ...
                  <div className="flex gap-4">
                    {product.color.map((color, idx) => (
                      <div key={idx} className="flex flex-col items-center">
                        <button
                          onClick={() =>
                            setSelectedColor({ index: idx, color })
                          }
      ...
      <div className="bg-gray-100 min-h-screen md:mb-0 mb-16 dark:bg-gray-900 sticky1 ">
        <div className="max-w-[1500px] mx-auto py-8 md:px-4 px-2 lg:px-0 ">
          <RecentlyViewed recentViews={recentViews} />
          <div className="sm:h-[30vh] h-[10vh] mt-20 flex justify-center items-center bg-white dark:bg-blue-950">
            <p className="text-3xl font-semibold text-center text-black dark:text-blue-200">
              Currently, this section is Pending...
            </p>
          </div>
        </div>
      </div>
      <div className="sm:h-[40vh] h-auto bg-gray-800 dark:bg-gray-900 text-white dark:text-gray-300 flex flex-col justify-between p-6 md:p-12 relative z-20">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center w-full">
          ...
          <div className="flex flex-col md:flex-row gap-4 md:gap-8 text-center">
            <a
              href="#"
              className="hover:text-gray-300 dark:hover:text-gray-400 transition duration-300"
            >
              Home
            </a>
            <a
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center mt-6">
          ...
          <div className="flex mt-4 md:mt-0">
            <input
              ...
              className="p-2 rounded-l-lg text-black w-64 border-none focus:outline-none"
            />
            <button className="bg-blue-600 hover:bg-blue-500 text-white p-2 rounded-r-lg">
              Subscribe
            </button>
          </div>
        </div>
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center mt-6 border-t border-gray-700 dark:border-gray-800 pt-4">
          {/* Social Media Links */}
          <div className="flex justify-center md:justify-start gap-4">
            <a
              href="#"
              className="text-blue-400 dark:text-blue-500 hover:text-blue-300 dark:hover:text-blue-400 transition duration-300"
            >
              <i className="fab fa-facebook text-xl"></i>
            </a>
            <a
              href="#"
              className="text-blue-500 dark:text-blue-600 hover:text-blue-400 dark:hover:text-blue-500 transition duration-300"
            >
              <i className="fab fa-twitter text-xl"></i>
            </a>
            <a
              href="#"
              className="text-red-500 dark:text-red-600 hover:text-red-400 dark:hover:text-red-500 transition duration-300"
            >
